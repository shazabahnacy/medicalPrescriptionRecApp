    ...
    await for (final IsolateData isolateData in port) {
      if (isolateData != null) {
        ...
        if (Platform.isAndroid) {
          ...
          Pointer<Uint8> p =
              calloc(isolateData.cameraImage.planes[0].bytes.length);
          Pointer<Uint8> p1 =
              calloc(isolateData.cameraImage.planes[1].bytes.length);
          Pointer<Uint8> p2 =
              calloc(isolateData.cameraImage.planes[2].bytes.length);
